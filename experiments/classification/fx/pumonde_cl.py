...
from models.tensorflow.pumonde_cl import PumondeCl
...
if __name__ == '__main__':
    ...
    exp.model_factory = TfSimpleTrainEvalModelFactory(PumondeCl())

    exp.hyper_param_search = GridSearch([
        Categorical([3,5], name='nl1'),
        Categorical([50,100], name='sl1'),
        Categorical([3,5], name='nl2'),
        Categorical([50,100], name='sl2'),
        Categorical([2,5], name='nl3'),
